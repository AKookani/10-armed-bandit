...
%       Softmax select with t=1
        ...
        total= sum(a.');
        f= randsrc(1,1,[1:10;(exp(Q(1,t)))/total,(exp(Q(2,t)))/total,(exp(Q(3,t)))/total,(exp(Q(4,t)))/total,...
            (exp(Q(5,t)))/total,(exp(Q(6,t)))/total,(exp(Q(7,t)))/total,(exp(Q(8,t)))/total,(exp(Q(9,t)))/total,...
            (exp(Q(10,t)))/total]);
...
% subplot(2,1,1);
% plot(t,RewPas)
% title('Softmax with constant Tau Reward')
% xlabel('steps')
% ylabel('Average reward')
% 
% subplot(2,1,2);
% plot(t,OptPas)
% title('Softmax with constant Tau Optimal Action')
% xlabel('steps')
