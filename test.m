...
% Last Modified by GUIDE v2.5 03-Feb-2021 23:23:46
...
switch list
    case 1
        ...
        axes(handles.axes1)
        plot(t,ar)
        title('e-Greedy Reward')
        xlabel('steps')
        ylabel('Average reward')

        axes(handles.axes2)
        plot(t,br)
        title('e-Greedy Optimal Action')
        xlabel('steps')
    ...
    case 2
        ...
        ylabel('%Optimal Actoin')
    case 3
        exponential_variable_epsilon_greedy()
        axes(handles.axes1)
        plot(t,ar)
        ...
        ylabel('%Optimal Actoin')
    case 4
        exponential_variable_Tau_Softmax()
        axes(handles.axes1)
        plot(t,ar)
        ...
        ylabel('%Optimal Actoin')
    case 5
        fraction_variable_epsilon_greedy()
        axes(handles.axes1)
        plot(t,ar)
