...
for n=1:2000
    ...
    %Inital
    Q(:,1)= a.';
%   Softmax select with Tau= t
    for i=1:10
        a(i)= exp(Q(i,1));
    end
    total= sum(a.');
    f= randsrc(1,1,[1:10;(exp(Q(1,1)))/total,(exp(Q(2,1)))/total,(exp(Q(3,1)))/total,(exp(Q(4,1)))/total,...
        (exp(Q(5,1)))/total,(exp(Q(6,1)))/total,(exp(Q(7,1)))/total,(exp(Q(8,1)))/total,(exp(Q(9,1)))/total,...
            (exp(Q(10,1)))/total]);
...
%       Softmax select with Tau=exp(t)
        ...
        total= sum(a.');
        f= randsrc(1,1,[1:10;(exp((Q(1,t))/(t)))/total,(exp((Q(2,t))/(t)))/total,(exp((Q(3,t))/(t)))/total,(exp((Q(4,t))/(t)))/total,...
            (exp((Q(5,t))/(t)))/total,(exp((Q(6,t))/(t)))/total,(exp((Q(7,t))/(t)))/total,(exp((Q(8,t))/(t)))/total,(exp((Q(9,t))/(t)))/total,...
              (exp((Q(10,t))/(t)))/total]);
...
% subplot(2,1,1);
% plot(t,RewPas)
% title('Softmax with Tau= t Reward')
% xlabel('steps')
% ylabel('Average reward')
% 
% subplot(2,1,2);
% plot(t,OptPas)
% title('Softmax with Tau= t Optimal Action')
% xlabel('steps')
